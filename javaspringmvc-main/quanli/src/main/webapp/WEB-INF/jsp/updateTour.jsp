...
<div class="container">
      <c:url value = "/admin/tour/update" var="action"/>
        <form:form method ="post" action="${action}" modelAttribute="tours" enctype="multipart/form-data">
            <form:errors path="*" cssClass="alert alert-danger" element="div"/>
                        
                         <div class = "form-group">
                        <label for ="idtour">ID Tour</label>
                        <form:input type = "text" id="idtour" readonly="true" path="idtour"  cssClass="form-control"/>
                        <form:errors path="idtour" cssClass="alert alert-danger" element="div"/>
                        </div>
                        <div class = "form-group">
